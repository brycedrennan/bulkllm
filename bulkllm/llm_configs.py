...
default_models = [
    LLMConfig(
        ...
        llm_family="gemini-2.5-flash-preview",
    ...
    LLMConfig(
        ...
        llm_family="openrouter-deepseek-deepseek-r1",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={},
        system_prompt=default_system_prompt,
    ...
    LLMConfig(
        ...
        llm_family="openrouter-deepseek-deepseek-chat",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={},
        system_prompt=default_system_prompt,
    ...
    LLMConfig(
        ...
        llm_family="openrouter-amazon-nova-pro",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={},
        system_prompt=default_system_prompt,
    ...
    LLMConfig(
        ...
        llm_family="openrouter-qwen-qwq-32b",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={},
        system_prompt=default_system_prompt,
    ...
    LLMConfig(
        ...
        llm_family="openrouter-meta-llama-llama-3.3-70b-instruct",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={},
        system_prompt=default_system_prompt,
    ...
    LLMConfig(
        ...
        llm_family="openrouter-mistralai-mistral-large",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={},
        system_prompt=default_system_prompt,
    ...
    LLMConfig(
        ...
        llm_family="openrouter-mistralai-mistral-small-3.1-24b-instruct",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={},
        system_prompt=default_system_prompt,
    ...
    LLMConfig(
        ...
        llm_family="openrouter-google-gemma-3-27b-it",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={},
        system_prompt=default_system_prompt,
    ...
    LLMConfig(
        ...
        llm_family="openrouter-meta-llama-llama-4",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={},
        system_prompt=default_system_prompt,
