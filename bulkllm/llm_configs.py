...
FAMILY_SUCCESSORS: dict[str, str] = {
    ...
    "anthropic/claude-3.7-sonnet": "anthropic/claude-4-sonnet",
    ...
    "xai/grok-3-mini": "xai/grok-4-fast",
    "openai/gpt-4": "openai/gpt-4o",
    "openai/gpt-4-turbo": "openai/gpt-4o",
    "openai/gpt-4o": "openai/openai/gpt-5-chat",
...
openai_configs = [
    ...
    # GPT-5 Chat (non-reasoning) latest alias
    LLMConfig(
        slug="openai-gpt-5-chat-latest",
        display_name="GPT-5 Chat",
        company_name="OpenAI",
        litellm_model_name="openai/gpt-5-chat-latest",
        llm_family="openai/gpt-5-chat",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={},
        system_prompt=DEFAULT_SYSTEM_PROMPT,
    ...
    # GPT-5 family - retain high reasoning variant and drop "thinking" from slug/display
    LLMConfig(
        slug="openai-gpt-5-20250807",
        display_name="GPT-5 20250807",
        company_name="OpenAI",
    ...
    LLMConfig(
        slug="openai-gpt-5-mini-20250807",
        display_name="GPT-5 Mini 20250807",
        company_name="OpenAI",
        litellm_model_name="openai/gpt-5-mini-2025-08-07",
        llm_family="openai/gpt-5-mini",
        temperature=1,
        max_completion_tokens=8000,
        system_prompt=DEFAULT_SYSTEM_PROMPT,
        release_date=date(2025, 8, 7),
    ...
    LLMConfig(
        slug="openai-gpt-5-nano-20250807",
        display_name="GPT-5 Nano 20250807",
        company_name="OpenAI",
        litellm_model_name="openai/gpt-5-nano-2025-08-07",
        llm_family="openai/gpt-5-nano",
        temperature=1,
        max_completion_tokens=8000,
        system_prompt=DEFAULT_SYSTEM_PROMPT,
        release_date=date(2025, 8, 7),
...
openrouter_configs = [
    ...
    LLMConfig(
        slug="openrouter-deepseek-chat-v3.1",
        display_name="DeepSeek V3.1 20250821",
        company_name="DeepSeek",
        litellm_model_name="openrouter/deepseek/deepseek-chat-v3.1",
        llm_family="deepseek/deepseek-chat-v3.1",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={},
        system_prompt=DEFAULT_SYSTEM_PROMPT,
    ...
    LLMConfig(
        slug="openrouter-deepseek-chat-v3.1-thinking",
        display_name="DeepSeek V3.1 Thinking 20250821",
        company_name="DeepSeek",
        litellm_model_name="openrouter/deepseek/deepseek-chat-v3.1",
        llm_family="deepseek/deepseek-chat-v3.1",
        temperature=default_temperature,
...
anthropic_configs = [
    ...
    LLMConfig(
        ...
        llm_family="anthropic/claude-4.5-sonnet",
        temperature=default_temperature,
        max_tokens=8000,
        thinking_config={},
        system_prompt=DEFAULT_SYSTEM_PROMPT,
    ...
    LLMConfig(
        slug="anthropic-claude-sonnet-4.5-thinking-20250929",
        display_name="Claude Sonnet 4.5 Thinking 20250929",
        company_name="Anthropic",
        litellm_model_name="anthropic/claude-sonnet-4-5-20250929",
        llm_family="anthropic/claude-4.5-sonnet",
        temperature=default_temperature,
    ...
    LLMConfig(
        slug="anthropic-claude-haiku-4.5-20251015",
        display_name="Claude Haiku 4.5 20251015",
        company_name="Anthropic",
        litellm_model_name="anthropic/claude-haiku-4-5-20251001",  # yes release date different than model identifier
        llm_family="anthropic/claude-4.5-haiku",
        temperature=default_temperature,
        max_tokens=8000,
        thinking_config={},
        system_prompt=DEFAULT_SYSTEM_PROMPT,
    ...
    LLMConfig(
        slug="anthropic-claude-haiku-4.5-thinking-20251015",
        display_name="Claude Haiku 4.5 Thinking 20251015",
        company_name="Anthropic",
        litellm_model_name="anthropic/claude-haiku-4-5-20251001",  # yes release date different than model identifier
        llm_family="anthropic/claude-4.5-haiku",
        temperature=default_temperature,
...
gemini_configs = [
    ...
    LLMConfig(
        slug="gemini-2.5-flash-20250925",
        display_name="Gemini 2.5 Flash 20250925",
        company_name="Google",
        litellm_model_name="gemini/gemini-2.5-flash-preview-09-2025",
        llm_family="gemini/gemini-2.5-flash",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={"type": "disabled", "budget_tokens": 0},
    ...
    LLMConfig(
        slug="gemini-2.5-flash-thinking-20250925",
        display_name="Gemini 2.5 Flash Thinking 20250925",
        company_name="Google",
        litellm_model_name="gemini/gemini-2.5-flash-preview-09-2025",
        llm_family="gemini/gemini-2.5-flash",
        temperature=default_temperature,
    ...
    LLMConfig(
        slug="gemini-2.5-flash-lite-20250925",
        display_name="Gemini 2.5 Flash Lite 20250925",
        company_name="Google",
        litellm_model_name="gemini/gemini-2.5-flash-lite-preview-09-2025",
        llm_family="gemini/gemini-2.5-flash-lite",
        temperature=default_temperature,
        max_tokens=default_max_tokens,
        thinking_config={"type": "disabled", "budget_tokens": 0},
    ...
    LLMConfig(
        slug="gemini-2.5-flash-lite-thinking-20250925",
        display_name="Gemini 2.5 Flash Lite Thinking 20250925",
        company_name="Google",
        litellm_model_name="gemini/gemini-2.5-flash-lite-preview-09-2025",
        llm_family="gemini/gemini-2.5-flash-lite",
        temperature=default_temperature,
...
xai_configs = [
    ...
    LLMConfig(
        slug="xai-grok-4-fast-20250919",
        display_name="Grok 4 Fast 20250919",
        company_name="xAI",
        litellm_model_name="xai/grok-4-fast-non-reasoning",
        llm_family="xai/grok-4-fast",
        temperature=default_temperature,
        max_tokens=8000,
        thinking_config={},
        system_prompt=DEFAULT_SYSTEM_PROMPT,
    ...
    LLMConfig(
        slug="xai-grok-4-fast-reasoning-20250919",
        display_name="Grok 4 Fast Reasoning 20250919",
        company_name="xAI",
        litellm_model_name="xai/grok-4-fast",
        llm_family="xai/grok-4-fast",
        temperature=default_temperature,
        max_tokens=8000,
        thinking_config={},
