...
gemini_configs = [
    ...
    LLMConfig(
        slug="gemini-gemini-2.5-flash-20250617-low",
        display_name="Gemini 2.5 Flash 20250617 (low)",
        company_name="Google",
        litellm_model_name="gemini/gemini-2.5-flash",
        llm_family="gemini/gemini-2.5-flash",
        temperature=default_temperature,
    ...
    LLMConfig(
        slug="gemini-gemini-2.5-flash-20250617-medium",
        display_name="Gemini 2.5 Flash 20250617 (medium)",
        company_name="Google",
        litellm_model_name="gemini/gemini-2.5-flash",
        llm_family="gemini/gemini-2.5-flash",
        temperature=default_temperature,
    ...
    LLMConfig(
        slug="gemini-gemini-2.5-flash-20250617-high",
        display_name="Gemini 2.5 Flash 20250617 (high)",
        company_name="Google",
        litellm_model_name="gemini/gemini-2.5-flash",
        llm_family="gemini/gemini-2.5-flash",
        temperature=default_temperature,
...
more_default_models = [
    ...
    LLMConfig(
        slug="openai-computer-use-preview-2025-03-11",
        display_name="Computer Use Preview 2025 03 11",
        company_name="Openai",
        litellm_model_name="openai/computer-use-preview-2025-03-11",
        llm_family="openai/computer-use-preview",
        temperature=default_temperature,
        max_tokens=8000,
        thinking_config={},
        system_prompt=default_system_prompt,
    ...
    LLMConfig(
        slug="xai-grok-2-vision-1212",
        display_name="Grok 2 Vision 1212",
        company_name="Xai",
        litellm_model_name="xai/grok-2-vision-1212",
        llm_family="xai/grok-2-vision",
        temperature=default_temperature,
        max_tokens=8000,
        thinking_config={},
        system_prompt=default_system_prompt,
...
default_models.extend(more_default_models)
