...
openai_configs = [
    ...
    # GPT-5 family - provide minimal and high reasoning effort variants
    LLMConfig(
    ...
    LLMConfig(
        slug="openai-gpt-5-thinking-20250807",
        display_name="GPT-5 Thinking 20250807",
        company_name="OpenAI",
        litellm_model_name="openai/gpt-5-2025-08-07",
        llm_family="openai/gpt-5",
        temperature=1,
    ...
    LLMConfig(
        slug="openai-gpt-5-mini-thinking-20250807",
        display_name="GPT-5 Mini Thinking 20250807",
        company_name="OpenAI",
        litellm_model_name="openai/gpt-5-mini-2025-08-07",
        llm_family="openai/gpt-5-mini",
        temperature=1,
    ...
    LLMConfig(
        slug="openai-gpt-5-nano-thinking-20250807",
        display_name="GPT-5 Nano Thinking 20250807",
        company_name="OpenAI",
        litellm_model_name="openai/gpt-5-nano-2025-08-07",
        llm_family="openai/gpt-5-nano",
        temperature=1,
